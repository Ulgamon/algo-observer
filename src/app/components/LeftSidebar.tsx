...
const categories: Category[] = [
  ...
  },
  {
    ...
    name: 'Stacks & Queues',
    algorithms: [
      { id: 'stack-implementation', name: 'Stack Implementation', status: 'ready' },
  ...
  },
  {
    ...
    name: 'Trees',
    algorithms: [
      { id: 'binary-tree-traversal', name: 'Binary Tree Traversal', status: 'soon' },
      { id: 'binary-search-tree', name: 'Binary Search Tree', status: 'soon' },
      { id: 'lowest-common-ancestor', name: 'Lowest Common Ancestor', status: 'ready' },
    ],
  },
  {
    id: 'graphs',
    ...
    algorithms: [
      ...
      { id: 'breadth-first-search', name: 'Breadth First Search', status: 'ready' },
      { id: 'dijkstra-algorithm', name: "Dijkstra's Algorithm", status: 'ready' },
    ],
  },
  {
    id: 'sorting',
  ...
  },
  {
    ...
    algorithms: [
      ...
      { id: 'longest-common-subsequence', name: 'Longest Common Subsequence', status: 'ready' },
    ],
  },
];

export function LeftSidebar({ isOpen, selectedAlgorithm, onSelectAlgorithm }: LeftSidebarProps) {
    ...
    <>
      ...
      <aside className="fixed lg:relative inset-y-0 left-0 z-40 w-64 border-r border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 flex flex-col">
        ...
        <div className="p-4 border-b border-zinc-200 dark:border-zinc-800">
          <h2 className="font-semibold text-zinc-900 dark:text-zinc-100">Topics</h2>
          <p className="text-xs text-zinc-600 dark:text-zinc-500 mt-1">Select an algorithm to learn</p>
        </div>
...
function CategorySection({ category, isExpanded, onToggle, selectedAlgorithm, onSelectAlgorithm }: CategorySectionProps) {
  return (
    <div className="mb-1">
      <button
        onClick={onToggle}
...
function AlgorithmItem({ algorithm, isSelected, onSelect }: AlgorithmItemProps) {
  return (
    <button
      onClick={onSelect}
